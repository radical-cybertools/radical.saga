...
def perf (n_jobs, urls) :
    ...
    try :
        ...
        rate    = n_jobs / (seconds)
        mem     = get_mem ()
        print "%8s  %8s  %-15s  %-15s  %8s  %s" % (n_services, n_jobs, seconds, rate, mem, ','.join (urls))
...
#     "xxxxxxxx  xxxxxxxx  xxxxxxxxxxxxxxx  xxxxxxxxxxxxxxx  xxxxxxxx  xxxx......"
print "services      jobs  time             jobs/sec           memory  urls"
...
# 
# perf (    0,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  1*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  2*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  3*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  4*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  5*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  6*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  7*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  8*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768,  9*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    0, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    1, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    2, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    4, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (    8, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   16, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   32, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (   64, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  128, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  256, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf (  512, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# perf ( 1024, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 2048, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 4096, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf ( 8192, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (16384, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# # perf (32768, 10*['gsissh://tg-login.ranger.tacc.teragrid.org/'])
# 
#  
