...
_SSH_FLAGS_MASTER   = "-o ControlMaster=yes -o ControlPath=%(ctrl)s -o TCPKeepAlive=no -o ServerAliveInterval=60"
_SSH_FLAGS_SLAVE    = "-o ControlMaster=no  -o ControlPath=%(ctrl)s -o TCPKeepAlive=no -o ServerAliveInterval=60"
