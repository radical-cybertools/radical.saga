...
_SSH_FLAGS_MASTER   = "-o ControlMaster=auto -o ControlPath=%(ctrl)s -o TCPKeepAlive=no  -o ServerAliveInterval=10 -o ServerAliveCountMax=20 -2 "
_SSH_FLAGS_SLAVE    = "-o ControlMaster=auto -o ControlPath=%(ctrl)s -o TCPKeepAlive=no  -o ServerAliveInterval=10 -o ServerAliveCountMax=20 -2 "
_SCP_FLAGS          = ""
_SFTP_FLAGS         = ""
