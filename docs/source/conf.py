...
.. |rtype_ttype| replace:: :class:`radical.saga.Task` if the operation is asynchronous.
...
latex_documents = [
  ('index', 'RADICAL-SAGA.tex', u'RADICAL-SAGA Documentation',
...
man_pages = [
    ('index', 'saga', u'RADICAL-SAGA Documentation',
